package com.adit.katalogpahlawan;

import android.content.Context;
import android.content.SharedPreferences;
import android.util.Log;

import com.adit.katalogpahlawan.Pahlawan;
import com.adit.katalogpahlawan.Pahlawan;
...
public class SharedPreferenceUtility {
     ...
     */
    public static List<Pahlawan> getAllTransaksi(Context ctx) {
    ...
    /*
        ...
        Perhatikan bahwa data disimpan dalam format JSON String
     */
    private static void saveAllTransaksi(Context ctx, List<Pahlawan> trs) {
     ...
     */
    public static void addTransaksi(Context ctx, Pahlawan tr) {
        List<Pahlawan> trs = getAllTransaksi(ctx);
        trs.add(tr);
        saveAllTransaksi(ctx,trs);
    }

    public static void editTransaksi(Context ctx, Pahlawan tr) {
        List<Pahlawan> trs = getAllTransaksi(ctx);
        for (Pahlawan tre:trs) {
