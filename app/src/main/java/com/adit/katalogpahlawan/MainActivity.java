...
import com.adit.katalogpahlawan.DaftarPahlawanAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupListview() {
        DaftarPahlawanAdapter adapter
                = new DaftarPahlawanAdapter(this, daftarTransaksi);
    ...
    private void refreshListView() {
        LinkedList<Object> adapter = null;
        adapter.clear();
        loadDataTransaksi();
    ...
    private void bukaFormTambahTransaksi() {
        Intent intent = new Intent(this, com.adit.katalogpahlawan.FormPahlawanActivity.class);
